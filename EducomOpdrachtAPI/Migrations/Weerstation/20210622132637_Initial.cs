        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemperatureGc = table.Column<double>(type: "float", nullable: false),
                    TemperatureCm = table.Column<double>(type: "float", nullable: false),
                    WindspeedMs = table.Column<double>(type: "float", nullable: false),
                    WindspeedBf = table.Column<int>(type: "int", nullable: false),
